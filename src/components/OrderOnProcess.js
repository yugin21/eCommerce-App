...
import { orderOnProcessURL } from '../../utils/Endpoints';

class OrderOnProcess extends Component {
    constructor() {
        super()
        this.state = {
            dataSource: [],
            ...
            <View style={styles.shippingInputContainer}>
                <View style={styles.selectedPaymentSection}>
                    <View style={{ borderBottomWidth: 1, paddingBottom: 10, borderBottomColor: '#dfe6e9' }}>
                        <Text style={styles.totalItem}>On Process</Text>
                    </View>
