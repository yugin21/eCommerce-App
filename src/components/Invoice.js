...
import { invoiceURL } from '../../utils/Endpoints';
            ...
            <ScrollView style={styles.shippingInputContainer}>
                <View style={styles.selectedPaymentSection}>
                    <View style={{ borderBottomWidth: 1, paddingBottom: 10, borderBottomColor: '#dfe6e9' }}>
                        <Text style={styles.totalItem}>Payment</Text>
                    </View>
                    <View style={styles.selectedAddressWrapper}>
                        <View style={styles.selectedAddressWrapper}>
                            ...
                            <Text style={styles.addressText}>Customer: {item.received_name}</Text>
                            <Text style={styles.addressText}>Address: {item.address}</Text>
                            <Text style={styles.addressText}>Zip Code: {item.zip}</Text>
                            <Text style={styles.addressText}>Phone: {item.phone}</Text>
                            <Text style={styles.addressText}>Sub Total: {item.amount}</Text>
                            <Text style={styles.addressText}>Shipping Cost: {item.shipping_cost}</Text>
