...
class LadiesSubCategory extends Component {
    constructor() {
        super()
        this.state = {
            dataSource: [],
    ...
    dataRequest() {
        ...
        const url = `http://e-commerce-rest-api.herokuapp.com/product/category/2?idSub=${id}`
            ...
            this.state.isLoading
                ...
                <View style={{ flex: 1, paddingTop: 15 }}>
                    <View style={{ paddingLeft: 15, paddingBottom: 10 }}>
                        <Text style={styles.productTitle}>Ladies Products</Text>
                    </View>
                    <FlatList
...
export default LadiesSubCategory;